import { Wifi, FolderOpen } from "lucide-react";
import {
  getNotesByCategory,
  getTagsByCategory,
  CATEGORY_INFO,
...
const CATEGORY = "networking" as const;
    ...
    <NotePageTransition>
      <div className="mb-10">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl border text-brand-blue border-brand-blue/20 bg-brand-blue/10">
